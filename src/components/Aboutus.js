    ...
    <Container className="py-5 text-white" style={{ direction: 'rtl', textAlign: 'right' }}>
      <Row className="align-items-center mb-5">
        ...
        <Col md={6}>
          ...
          <p>
            קייטרינג "ביוטיפוד – מגשי אירוח", רמה אחת מעל כולם!<br />
            קייטרינג "ביוטיפוד- מגשי אירוח" הוא סיפור הצלחה של סנדביצ'ייה קטנה שגדלה והפכה לחברת קייטרינג מובילה.
      ...
      <Row className="mb-4">
        <Col>
          <h4 className="fw-semibold" style={orangeStyle} > יש מגשי אירוח ויש את ביוטיפודס!</h4>
          <p>
      ...
      <Row className="mb-4">
        <Col>
          ...
          <p>
            המטבח החלבי כובש את העולם, וגם את ישראל. בביוטיפוד אנו שואבים השראה מהמטבחים הצרפתי, האיטלקי והעולמי,
      ...
      <Row className="mb-4">
        <Col>
          ...
          <ul>
            <li>לחמים נאפים כל בוקר בקונדיטוריה הביתית של ביוטיפודס</li>
            <li>פירות וירקות טריים נחתכים סמוך להגשה</li>
            <li>אישור משרד הבריאות ורישיון יצרן: 70017</li>
            <li>כשר מהדרין בד"צ העדה החרדית ובית יוסף</li>
